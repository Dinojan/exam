...
class Router
{
    ...
    public function loadRoutes($rf)
    {
        $routesFile = ROUTES_PATH . $rf . '.php';
    ...
    private function executeAction($action, $params = [])
    {
        if (is_callable($action)) {
            ...
            $controllerFile = API_PATH . "{$controllerName}.php";
