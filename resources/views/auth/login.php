...
<div class="glass-effect rounded-3xl p-8 w-full max-w-md floating" style="animation-duration: 6s;">
    <div class="text-center mb-2">
        <div class="inline-block p-2 rounded-full bg-gradient-to-r from-blue-400 to-purple-400 mb-4 pulse">
            <!-- <i class="fas fa-user text-white text-2xl"></i> -->
             <img src="<?php echo asset('assets/img/logo.png') ?>" alt="Logo" class="h-16 w-16 object-cover overflow-hidden">
        </div>
